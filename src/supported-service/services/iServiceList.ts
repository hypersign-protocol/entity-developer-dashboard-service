...
export namespace SERVICES {
  ...
  export namespace CAVACH_API {
    export enum ACCESS_TYPES {
      ...
      DELETE_WIDGET_CONFIG = 'DELETE_WIDGET_CONFIG',
      ...
      READ_COMPANY_EXECUTIVES = 'READ_COMPANY_EXECUTIVES',
      WRITE_COMPANY_EXECUTIVES = 'WRITE_COMPANY_EXECUTIVES',
      UPDATE_COMPANY_EXECUTIVES = 'UPDATE_COMPANY_EXECUTIVES',
      DELETE_COMPANY_EXECUTIVES = 'DELETE_COMPANY_EXECUTIVES',
      RESEND_COMPANY_EXECUTIVES_MAIL = 'RESEND_COMPANY_EXECUTIVES_MAIL',
